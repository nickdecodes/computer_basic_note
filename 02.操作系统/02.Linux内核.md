* [块I/O层](#块io层)
	...
	* [3.块(block)](#3块block)
	* [4.buffer_head结构](#4buffer-head结构)
	* [5.bio结构](#5bio结构)
	* [6.I/O请求队列与I/O请求](#6I/O请求队列与I/O请求)
	* [7.调度算法](#7调度算法)
		* [7.1 Elevator(电梯)](#71-elevator电梯)
		* [7.2 Deadline(截止日期)](#72-deadline截止日期)
		* [7.3 Anticipatory(预测)](#73-anticipatory预测)
		* [7.4 CFQ(完全公平队列)](#74-cfq完全公平队列)
		* [7.5 Noop](#75-noop)
		* [7.6 查看与选择可用的调度算法](#76-查看与选择可用的调度算法)
...
<div align="center"> <img src="./pic/02-03.png"/> </div>
...
<div align="center"> <img src="./pic/02-04.png"/> </div>
